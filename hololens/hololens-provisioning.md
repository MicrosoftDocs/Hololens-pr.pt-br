...
- Configure o modo de quiosque seguindo nossas [instruções detalhadas](hololens-kiosk.md?tabs=ppkgmak#steps-in-configuring-kiosk-mode-for-hololens).
...
3. HoloLens aparece como um dispositivo no Explorador de Arquivos no computador.
...
2. Conexão o HoloLens em um computador usando um cabo USB. HoloLens aparece como um dispositivo no Explorador de Arquivos no computador.
...
Os aplicativos podem ser instalados por meio de pacotes de provisionamento HoloLens 2 dispositivos. Isso permite um pacote facilmente rea usável que você pode usar para ajudá-lo a distribuir seus aplicativos. Leia as instruções completas para [implantar aplicativos por meio de Pacotes de Provisionamento](app-deploy-provisioning-package.md).  
