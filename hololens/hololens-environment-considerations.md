...
---
# <a name="hololens-environment-considerations"></a>Considerações de ambiente HoloLens
...
## <a name="environment-management"></a>Gerenciamento do ambiente
...
1. Se você seguir as diretrizes acima, mas tiver problemas inesperados de superaquecimento, certifique-se de que a telemetria Completa/Opcional esteja habilitada antes de enviar [Comentários](hololens-feedback.md). A telemetria Completa/Opcional será necessária para investigar problemas de superaquecimento.
