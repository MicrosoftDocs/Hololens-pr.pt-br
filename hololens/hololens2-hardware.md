...
- **Suporte da testa**. Você pode remover e substituir o suporte da testa, conforme necessário.
- **Faixa sobre a cabeça**. Quando estiver utilizando o HoloLens ao se movimentar, use a faixa sobre a cabeça para ajudar a manter o dispositivo no lugar. Ao usar o HoloLens por períodos prolongados, a faixa sobre a cabeça pode tornar o uso do dispositivo mais confortável.
- **Cabo USB-C**. Use o cabo USB-C para conectar o HoloLens à fonte de alimentação para carregamento ou para conectar o HoloLens ao seu computador.
...
|   |   |
| - | - |
| Duração da bateria | 2-3 horas de uso ativo. Até 2 semanas de tempo de espera. |
...
| Email e Calendário | Os aplicativos [Email e Calendário](https://www.microsoft.com/p/mail-and-calendar/9wzdncrfhvqm#activetab=pivot:overviewtab) ajudam você a se manter atualizado sobre seu email, gerenciar sua agenda e interagir com seus contatos. |  
