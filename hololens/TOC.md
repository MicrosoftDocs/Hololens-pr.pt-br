...
### [Hardware do HoloLens (1ª gen)](hololens1-hardware.md)
### [Preparar seu HoloLens (1ª geração) para uso](hololens1-setup.md)
### [Configurar seu HoloLens (1ª geração)](hololens1-start.md)
### [Perguntas frequentes sobre ajuste e conforto do HoloLens (1ª geração)](hololens1-fit-comfort-faq.md)
### [Instalar a versão localizada do HoloLens (1ª gen)](hololens1-install-localized.md)
...
## Holograma ótico e posicionamento no espaço
...
## [Malha da Microsoft (Visualização)](/mesh/overview)

# Preparar
## [Implantar o HoloLens em um ambiente comercial](hololens-requirements.md)
## Cenários de Implantação Comuns
### [Cenários de Implantação de Infraestrutura](common-scenarios.md)
### Implantação do HoloLens 2 conectado à nuvem com Assistência Remota
#### [Conectado à nuvem - Visão geral da Implantação](hololens2-cloud-connected-overview.md)
#### [Conectado à nuvem - Preparar](hololens2-cloud-connected-prepare.md)
...
### [Atestado de segurança e de tempo de execução com suporte para hardware](security-hardware-backed-integrity.md)
...
### [Declaração de privacidade do HoloLens 2](hololens2-compliance.md)
## [Requisitos de licença](hololens-licenses-requirements.md)
## Ambiente
### [Considerações de ambiente HoloLens](hololens-environment-considerations.md)
### [Mapear espaços físicos com o HoloLens](hololens-spaces.md)
...
# Implantar
## Inscrição
### [Registrar HoloLens em MDM](hololens-enroll-mdm.md)
### [Piloto automático do Windows para HoloLens 2](hololens2-autopilot.md) 
### [Inscreva-se em um ambiente Wi-Fi restrito do endereço MAC](mac-address-options.md)
## Aplicativos
### [Visão geral do gerenciamento de aplicativo](app-deploy-overview.md)
...
### [Perguntas frequentes](hololens-faq.md)
### [Problemas conhecidos do HoloLens](hololens-known-issues.md)
### [Coletar e usar informações de diagnóstico de dispositivos HoloLens](hololens-diagnostic-logs.md)
### [Obter suporte técnico](https://support.microsoft.com/supportforbusiness/productselection?sapid=e9391227-fa6d-927b-0fff-f96288631b8f)
