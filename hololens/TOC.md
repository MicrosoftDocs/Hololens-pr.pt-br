...
### [Atualizar o HoloLens](hololens-update-hololens.md)
## Uso diário
...
#### [Encontrar, instalar e desinstalar aplicativos da Store](holographic-store-apps.md)
...
# Como implantar o HoloLens 2
## [Cenários comuns de implantação](hololens-requirements.md)
## [Como planejar a implantação do HoloLens 2](hololens-core-components.md)
...
### [Proteção de dados e privacidade do HoloLens 2](hololens2-privacy.md)
...
### [HoloLens Informações de referência de quiosque](hololens-kiosk-reference.md)
...
## [Hologramas e interações](hololens-faq.md)
...
## [Saiba mais sobre o Microsoft Mesh (versão prévia)](/mesh/overview)
## HoloLens (1ª geração)
### Uso pela primeira vez
