...
## 1. Introdução
Você pode optar por usar esses dispositivos em um ambiente comercial para sua empresa. Esses dispositivos podem ser configurados para serem avançados para qualquer desenvolvedor ou organização. 

Cada edição do HoloLens 2 tem o mesmo hardware, o mesmo [conteúdo na caixa](../hololens2-hardware.md#hololens-components) e vem com o mesmo [software pré-instalado](../hololens2-hardware.md#pre-installed-software).

## 2. implantar dispositivos do HoloLens em sua organização
Esta seção o levará e sua organização estará pronta para implantar dispositivos HoloLens. 

### Preparar
| Checkpoint  | Resultado  |
|---|---|
| [Implantar o HoloLens em um ambiente comercial](../hololens-requirements.md).   | Você aprendeu as considerações.  |
| Considere a [implantação da infraestrutura](../common-scenarios.md).  | Você avaliou sua infraestrutura.  |
| Considere a [identidade](../hololens-identity.md) a ser usada por seus dispositivos.  | Você sabe qual identidade escolheu e se ela está limitada.   |
...
| Checkpoint  |  Resultado  |
|---|---|
| [Gerenciar atualizações do HoloLens](../hololens-updates.md).  | Você compreende como gerenciar as atualizações do seu dispositivo.   |
| [Solucionar](../hololens-troubleshooting.md) problemas.  | Você sabe onde ir para solucionar problemas com o HoloLens.   |

## 3. Explore as soluções

| Solução | Descrição resumida                                                                                |
|----------|---------------------------------------------------------------------------------------------------|
| [Dynamics 365 para HoloLens](https://www.microsoft.com//hololens/apps)          | Capacitar funcionários e otimizar as operações.                                                        |
| [Assistência Remota do Dynamics 365](https://dynamics.microsoft.com/mixed-reality/remote-assist/)          | Capacitar técnicos a colaborar de maneira mais eficiente trabalhando em conjunto em locais diferentes. |
|   [Guias do Dynamics 365](https://dynamics.microsoft.com/mixed-reality/guides/)        | Melhore o treinamento de necessidades efetivas e saiba como os funcionários estão realizando.                          |
|  [Serviços de nuvem do Azure para realidade mista](https://docs.microsoft.com/windows/mixed-reality/develop/mixed-reality-cloud-services#:~:text=Mixed%20Reality%20services%20Mixed%20Reality%20cloud%20services%20like,all%20in%20the%20context%20of%20your%20users%E2%80%99%20environments)         | Saiba como desenvolver uma solução usando os serviços de nuvem do Azure.                                       |
|  [Começar a desenvolver para o HoloLens 2](https://docs.microsoft.com/windows/mixed-reality/develop/development?tabs=unity)         | Construa uma solução de realidade mista para atender às suas necessidades.                                                 |

## Recursos adicionais

### Configurar um dispositivo individual
1. [Prepare o seu dispositivo para usá](https://docs.microsoft.com/hololens/hololens2-setup) -lo e, em seguida, [comece a configurar](https://docs.microsoft.com/hololens/hololens2-start).
1. [Saiba como contornar o HoloLens 2](https://docs.microsoft.com/hololens/holographic-home).
1. Após&#39;, [faça algumas fotos ou vídeos de realidade misturada](https://docs.microsoft.com/hololens/holographic-photos-and-videos).
1. Examine todos os aplicativos disponíveis [para o HoloLens 2 no aplicativo da Microsoft Store](https://docs.microsoft.com/hololens/holographic-store-apps).
...
# [Assistência remota do HoloLens 2 com o Dynamics 365 Remote ASSIST](#tab/remoteassist)

## 1. saiba mais sobre o HoloLens 2 com a assistência remota do Dynamics 365
- Você pode optar por usar esses dispositivos em um ambiente comercial para sua empresa. Solicite o máximo de que precisar.
- Um dos usos mais populares para o HoloLens no ambiente empresarial é a capacidade de usar a assistência remota. Com essa opção, você obtém uma licença para um assento (por dispositivo).
...
## 4. Explore as soluções

| Solução | Descrição resumida                                                                                |
|----------|---------------------------------------------------------------------------------------------------|
| [Dynamics 365 para HoloLens](https://www.microsoft.com//hololens/apps)          | Capacitar funcionários e otimizar as operações.                                                        |
|   [Guias do Dynamics 365](https://dynamics.microsoft.com/mixed-reality/guides/)        | Melhore a eficácia do treinamento e saiba como os funcionários estão realizando.                          |
|  [Serviços de nuvem do Azure para realidade mista](https://docs.microsoft.com/windows/mixed-reality/develop/mixed-reality-cloud-services#:~:text=Mixed%20Reality%20services%20Mixed%20Reality%20cloud%20services%20like,all%20in%20the%20context%20of%20your%20users%E2%80%99%20environments)         | Saiba como desenvolver uma solução usando os serviços de nuvem do Azure.                                       |
|  [Começar a desenvolver para o HoloLens 2](https://docs.microsoft.com/windows/mixed-reality/develop/development?tabs=unity)         | Construa uma solução de realidade mista para atender às suas necessidades.                                                 |


# [Edição de desenvolvimento do HoloLens 2](#tab/developeredition)
...
| Recurso de grupo | Descrição |
|---|---|
|  [Unity](https://unity.com/) | Uma plataforma de desenvolvimento 3D em tempo real.   |
|  [Plug-in do Pixyz para Unity](https://www.pixyz-software.com/plugin/) | Uma ponte para conectar os mundos do CAD de engenharia &amp; ao mundo de desenvolvimento.   |
| [$500 nos créditos do Azure para serviços do Azure](https://azure.microsoft.com/resources/) | Os créditos do Azure incluídos na edição de desenvolvimento do HoloLens 2 são para começar a criar e testar rapidamente aplicativos de realidade misturada no Azure. |
...
Como resgatar créditos do Azure: para resgatar seus créditos do $500 do Azure, resgate o código promocional aprovado do Azure e ative sua assinatura. [Saiba mais.](../hololens2-development-edition-faq.md#how-can-i-redeem-my-500-azure-credit)

- [Saiba como as âncoras espaciais do Azure podem ajudá-lo a criar aplicativos que mapeiem, compartilhem e persistam o conteúdo 3D](https://azure.microsoft.com/services/spatial-anchors/)
- [Saiba como a renderização remota do Azure pode renderizar conteúdo 3D interativo de alta qualidade e transmiti-lo para seus dispositivos em tempo real](https://azure.microsoft.com/services/remote-rendering/)
