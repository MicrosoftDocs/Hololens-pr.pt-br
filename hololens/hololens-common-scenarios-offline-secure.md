...
1. [Baixe o arquivo HoloLens sistema operacional 2 mais](https://aka.ms/hololens2download) recente diretamente para um computador. 
   1. O suporte para essa configuração está incluído no Build 19041.1117 e superior.
1. Baixe/instale a ferramenta ARC (Advanced Recovery Companion) [do Microsoft Store](https://www.microsoft.com/store/productId/9P74Z35SFRS8) para seu computador
...
1. O projeto deve ser aberto e agora você deve ter uma lista de Personalizações Disponíveis:
   ...
   |     Políticas/Conectividade/AllowBluetooth                |     No                            |     Desabilita Bluetooth                                                                                                             |
   |     Políticas/Experiência/AllowCortana                    |     No                            |     Desabilita Cortana (para eliminar possíveis problemas, pois os microfones estão desabilitados)                                          |
...
1. No HoloLens 2, pressione a combinação de botão a seguir para executar o Pacote de Provisionamento: Toque em **Volume Para** Baixo e **Botão** de Energia ao mesmo tempo.
