...
Esse erro normalmente é encontrado durante a redefinição e rea utilização de fluxos de dispositivos em que um HoloLens passou pelo Autopilot pelo menos uma vez. Para resolver esse problema, exclua o dispositivo do Microsoft Intune e [redefini-lo](/mem/autopilot/troubleshoot-device-enrollment#error-code-0x80180014-when-re-enrolling-using-self-deployment-or-pre-provisioning-mode) novamente para concluir o fluxo do Autopilot.
