...
---
# Usar sua voz para operar o HoloLens
...
|Open the Start menu | "Ir até o Início" |
|Close the Start menu | "Fechar" |
|Leave an immersive app | Diga "Ir até o Início" para exibir o menu de ações rápidas e diga "página inicial de realidade misturada". |
|Hide and show hand ray | "Ocultar raio manual" / "Mostrar raio manual" |
|See available speech commands | "O que posso dizer" |
...
Muitos botões e outros elementos no HoloLens também respondem à sua voz, por exemplo, **Siga-me** e **Fechar** na barra de aplicativos ou o botão **Voltar** no Edge. Para descobrir se um botão está habilitado para voz, descanse o **cursor de foco**, o ** cursor de toque** ou o **raio manual** sobre ele por um momento. Se o botão estiver habilitado para voz, uma dica de voz será exibida.

### Modo de ditado

Está cansado de digitar? Alterne para o modo de ditado a qualquer momento em que o teclado holográfico estiver ativo. Para começar, selecione o botão do microfone ou diga "Iniciar ditado". Para parar de ditar, selecione o botão novamente ou diga "Parar ditado". Para excluir o que você acabou de ditar, diga "Excluir isso". 
...
## Faça mais com a Cortana

A Cortana pode ajudar você a fazer uma infinidade de coisa no HoloLens, mas dependendo da versão do Windows Holographic que você está usando, os recursos podem ser diferentes. Você pode saber mais sobre os recursos atualizados da versão mais recente do Cortana [aqui](https://blogs.windows.com/windowsexperience/2020/02/28/cortana-in-the-upcoming-windows-10-release-focused-on-your-productivity-with-enhanced-security-and-privacy/). 
