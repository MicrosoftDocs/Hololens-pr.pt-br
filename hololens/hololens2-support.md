...
- [Âncoras de Objeto do Azure](https://stackoverflow.com/questions/tagged/azure-object-anchors)
- [MRTK (Kit de Ferramentas de Realidade Misturada)](https://stackoverflow.com/questions/tagged/MRTK)
...
| Austrália |   1800-217-709 |  Seg a sexta-feira, das 8h às 20h |
| Singapura |   1800 622-1816 | Seg a sexta-feira, das 8h30 às 17h30 |
| Nova Zelândia | 0800 471 640 |  Seg a sexta-feira, das 8h às 18h |

>[!IMPORTANT]
>Se você precisar de uma fatura de IVA completa, entre em contato com a equipe da Loja de Suporte Comercial diretamente e não compre um dispositivo online. Todas as compras feitas online receberão apenas uma fatura de IVA simplificada que não poderá ser editada posteriormente.

## <a name="azure-mixed-reality-services-support"></a>Suporte aos serviços de realidade misturada do Azure

### <a name="open-an-azure-portal-technical-support-ticket"></a>Abrir um tíquete portal do Azure suporte técnico

Para abrir um tíquete de suporte técnico no portal do Azure âncoras espaciais do Azure, Âncoras de Objeto do Azure ou Azure Remote Rendering:

1. Com o [portal do Azure](https://azure.microsoft.com/account/) aberto, selecione o ícone ajuda na barra de menus superior e selecione **Ajuda + suporte**.

   ![portal do Azure ajuda e suporte.](../hololens/images/azure-help-support.png)

2. Na página Ajuda + suporte aberta, selecione **+ Nova solicitação de suporte**.

   ![portal do Azure nova solicitação de suporte.](../hololens/images/azure-help-support2.png)

3. Ao concluir o preenchimento dos campos do tíquete de suporte:

    + Tipo de problema: técnico
    + Serviço: Âncoras Espaciais do Azure, Azure Remote Rendering ou Âncoras de Objeto do Azure

    ![portal do Azure campos de tíquete de suporte.](../hololens/images/azure-help-support3.png)

    1. Clique **em Avançar: Soluções** na parte inferior da página para adicionar mais detalhes para nos contar mais sobre o problema.

    2. Preencha o formulário o mais preciso e detalhado possível, juntamente com sua maneira preferencial de falar com você.

    3. Revise todas as informações que você preencheu nas seções anteriores e envie a solicitação de suporte.

### <a name="provide-documentation-content-feedback"></a>Fornecer comentários sobre o conteúdo da documentação

Na parte inferior de cada artigo de conteúdo, há uma oportunidade de abrir um problema GitHub e fornecer comentários sobre o conteúdo em qualquer repositório de documentação de realidade misturada. 

### <a name="provide-product-feedback"></a>Fornecer comentários sobre o produto

>[!Note]
>Fornecer comentários é uma excelente maneira de ouvir sua voz, no entanto, os comentários não são uma maneira de receber uma resposta. O Hub de Comentários pode ser combinado com outras opções de suporte.

Para fornecer comentários, compartilhe uma ideia ou sugestões para os serviços de realidade misturada da Microsoft ou vote nas ideias que outras pessoas tenham enviado, visite: 

- [HoloLens 2 Comentários sobre o produto](/hololens/hololens-feedback)
- [Comentários sobre o produto do aplicativo Microsoft Mesh](/hololens/hololens-feedback)
- [Azure Remote Rendering comentários](https://feedback.azure.com/forums/928696-azure-remote-rendering)
- [Comentários sobre âncoras espaciais do Azure](https://feedback.azure.com/forums/919252-azure-spatial-anchors)
